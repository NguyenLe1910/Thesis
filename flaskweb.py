from flask import Flask,render_template, Response, request, send_from_directory,redirect, url_for,stream_with_context,jsonify,get_flashed_messages
...
def sys_status_stream():
    RCid = get_flashed_messages('RCid')
    print(RCid)
